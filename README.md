...
For every NFL sunday in the last half decade, 3 of my closest friends have put our heads together in pursuits of striking it big by picking 4 definite winners to cover their spread. Coined "The Lock of the Week", this process evolved and refined itself with time, to where collaboration on these picks happens like clockwork at 11AM on sunday morning. Some of the tasks include researching all the  vegas predictions for the game, analyzing kickoff time, weather conditions, injury report and shopping between competing sportsbooks.
